...
from dash_bootstrap_components import Container, Navbar, NavbarBrand, Switch
            ...
            children=[
                Container(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                html.A(
                                    ...
                                    children=[
                                        html.Img(
                                            src="assets/images/aifi-white-logo.png",
                                            alt="AI logo",
                                            height="32",
                                            className="me-1",
                                        )
                                ...
                                html.A(
                                    ...
                                    children=[
                                        html.Img(
                                            src="assets/images/aifi-white-text.png",
                                            alt="AI logo",
                                            height="32",
                                            className="me-1",
                                        )
                        ...
                        # project title
                        html.Div(NavbarBrand(title), className="m-0"),
                        # control bar with optional study overview link, settings page, light/dark switch, and help page.
                        html.Div(
                            [
                                html.A(
                                    href=study_url,
